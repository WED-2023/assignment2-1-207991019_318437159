    ...
    <div class="modal-background">
      <div class="modal-content-wrapper">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.preview) && !recipe.preview }"
          >
          ...
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.summary) && !recipe.summary }"
          >
          ...
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.cuisine) && !recipe.cuisine }"
          >
          ...
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.diets) && !recipe.diets.length }"
          >
            <label>Diets</label>
            <multiselect
          ...
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.intolerances) && !recipe.intolerances.length }"
          >
            ...
            <multiselect
              ...
              :state="showErrors || touched.intolerances ? !!recipe.intolerances.length : null"
            ></multiselect>
          </div>
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.ingredients) && !recipe.ingredients.length }"
          >
            <label>Ingredients <span class="mandatory">*</span></label>
            <div v-for="(ingredient, index) in recipe.ingredients" :key="index" class="form-inline mb-2">
              <b-form-input
                type="text"
                v-model="ingredient.name"
                @blur="touched.ingredients = true"
                placeholder="Ingredient"
                :state="showErrors || touched.ingredients ? !!ingredient.name : null"
                required
              ></b-form-input>
              <b-form-input
                type="number"
                ...
                @blur="touched.ingredients = true"
                placeholder="Amount"
                :state="showErrors || touched.ingredients ? !!ingredient.amount : null"
                required
              ></b-form-input>
              <b-form-select
                ...
                :state="showErrors || touched.ingredients ? !!ingredient.unit : null"
                required
              >
              ...
              <b-form-input
                ...
                :state="showErrors || touched.ingredients ? !!ingredient.otherUnit : null"
                required
              ></b-form-input>
              <b-button
                variant="danger"
            ...
            <b-button variant="info" @click="addIngredient">+ Add Ingredient</b-button>
          </div>
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.instructions) && !recipe.instructions.length }"
          >
            <label>Instructions <span class="mandatory">*</span></label>
            <div v-for="(instruction, index) in recipe.instructions" :key="index" class="form-inline mb-2">
              <b-form-textarea
                v-model="instruction.step"
                @blur="touched.instructions = true"
                placeholder="Step"
                :state="showErrors || touched.instructions ? !!instruction.step : null"
                required
              ></b-form-textarea>
              <b-button
                variant="danger"
          ...
          <div
            class="form-group"
            :class="{ 'has-error': (showErrors || touched.servings) && !recipe.servings }"
          >
          ...
          >
            <label>Time to make (in minutes) <span class="mandatory">*</span></label>
            <b-form-input
              type="number"
              v-model="recipe.time"
...
import { mockSaveNewRecipe, mockGetCategoriesForSearch } from "../services/recipes.js";
